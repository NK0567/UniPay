...
router.post('/generate', authMiddleware, verifierVerrouOperation, ctrl.genererLien.bind(ctrl));
...
router.post('/pay', authMiddleware, verifierVerrouOperation, ctrl.payerLien.bind(ctrl));
